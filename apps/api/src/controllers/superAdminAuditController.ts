...
export class SuperAdminAuditController {
    ...
    static async getAuditTrail(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            if (req.user?.role !== 'super_admin') {
                return sendError(res, 'UNAUTHORIZED', 'Super admin access required', 403);
            }
            ...
            sendSuccess(res, result, 'Audit trail retrieved successfully');
        } catch (error) {
    ...
    static async getAuditStats(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendError(res, 'SERVER_ERROR', 'Failed to retrieve audit statistics', 500);
        }
    }
    ...
    static async exportAuditData(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendError(res, 'SERVER_ERROR', 'Failed to export audit data', 500);
        }
    }
    ...
    static async getUserActivityTimeline(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendError(res, 'SERVER_ERROR', 'Failed to retrieve user activity timeline', 500);
        }
    }
    ...
    static async getEntityActivityHistory(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            }, 'Entity activity history retrieved successfully');
        } catch (error) {
            logger.error('Error fetching entity activity history:', error);
            sendError(res, 'SERVER_ERROR', 'Failed to retrieve entity activity history', 500);
        }
    }
    ...
    static async searchAuditLogs(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendError(res, 'SERVER_ERROR', 'Failed to search audit logs', 500);
        }
    }
    ...
    static async flagAuditEntry(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            if (!updated) {
                return sendError(res, 'NOT_FOUND', 'Audit entry not found', 404);
            }
            ...
            await UnifiedAuditService.logActivity(
                {
                    ...
                    description: `${req.user.firstName} ${req.user.lastName} ${flagged ? 'flagged' : 'unflagged'
                        } audit entry`,
                    targetEntity: {
                        entityType: 'AuditLog',
                        entityId: auditId,
            ...
            sendSuccess(res, updated, `Audit entry ${flagged ? 'flagged' : 'unflagged'} successfully`);
        } catch (error) {
            logger.error('Error flagging audit entry:', error);
            sendError(res, 'SERVER_ERROR', 'Failed to flag audit entry', 500);
        }
    }
    ...
    static async reviewAuditEntry(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            if (!reviewNotes) {
                return sendError(res, 'VALIDATION_ERROR', 'Review notes are required', 400);
            }
            ...
            sendSuccess(res, updated, 'Audit entry reviewed successfully');
        } catch (error) {
            logger.error('Error reviewing audit entry:', error);
            sendError(res, 'SERVER_ERROR', 'Failed to review audit entry', 500);
        }
    }
    ...
    static async getActivityTypes(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendSuccess(res, activityTypes, 'Activity types retrieved successfully');
        } catch (error) {
            logger.error('Error fetching activity types:', error);
            sendError(res, 'SERVER_ERROR', 'Failed to retrieve activity types', 500);
        }
    }
    ...
    static async getRiskLevels(req: AuthRequest, res: Response): Promise<void> {
        try {
            ...
            sendSuccess(res, riskLevels, 'Risk levels retrieved successfully');
        } catch (error) {
            logger.error('Error fetching risk levels:', error);
            sendError(res, 'SERVER_ERROR', 'Failed to retrieve risk levels', 500);
        }
    }
}
