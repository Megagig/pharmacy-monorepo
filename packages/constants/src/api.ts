...
export const API_ENDPOINTS = {
    ...
    PATIENTS: {
        ...
        ALLERGIES: (patientId: string) => `/api/patients/${patientId}/allergies`,
        CONDITIONS: (patientId: string) => `/api/patients/${patientId}/conditions`,
        MEDICATIONS: (patientId: string) => `/api/patients/${patientId}/medications`,
        ASSESSMENTS: (patientId: string) => `/api/patients/${patientId}/assessments`,
        DTPS: (patientId: string) => `/api/patients/${patientId}/dtps`,
        CARE_PLANS: (patientId: string) => `/api/patients/${patientId}/care-plans`,
        VISITS: (patientId: string) => `/api/patients/${patientId}/visits`,
    },
